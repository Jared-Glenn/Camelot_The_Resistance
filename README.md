...
Some abilities, like Exile can be handled through the app, allowing a player to select a target and reveal information as needed. In these cases, if the ability involves players leaving the room, they must still do so.
