...
Roles are very different in this game, though, and we also introduce a scoring mechanic. In order to play, players will need to get used to the new rules or reference them in the app through the course of play.
...
When completed, the app will be available here.
...
Depending on the number of players, the pool of possible roles will change. This is meant to ensure that both sides are balanced and that no roles are unfairly weak or strong. The pool of roles is adjusted automatically by the program.
