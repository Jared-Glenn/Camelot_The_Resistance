...
3) **Quest Proposal:** The Leader proposes several players, up to the number written on the next quest on the board. Leaders can choose themselves for a quest.
