...
3) **Victory Points:** Victory Points are added up and compared, determining the winner(s) of the game, as well as the player rankings!


## The App
Each player needs to download the mobile app and input the group code, provided on the host's game screen. Once all players have joined and the game mode has been selected, the app will automatically assign a role to each player and provide character-specific information including your role, allegiance, and origin. Known information about other players is also provided on this screen, as well as misinformation generated by your role or another player's role. This information should be kept as private as possible, but can be reviewed at any point during the game by returning to the Role Info tab. After this information has been read and clarified, the game begins with the designated leader selecting the player who holds the scabbard and then choosing players for the first quest.

Some abilities can be handled directly through this app, allowing a player to select a target and reveal information as needed. The ability "Exile" is handled in this way. In these cases, if the ability involves players leaving the room, they should still remove themselves. It is not necessary for players to show one another their phones, as sharing information will happen automatically through the app. Additional information, when applied mid-game, will be displayed as a notification for each relevant player. Known information can be reviewed at any time, even if forgotten by the player.
...
If the Holy Grail has not yet been corrupted, you can prevent this corruption by not sending Fae on Quests. If the Grail has already been corrupted, watch your fellow players to determine if they are Fae so you can identify one during the Wild Hunt.
...
### Relics
Relics are powerful items that the players have access to throughout the game: The Holy Grail and Excalibur. Both of them represent a powerful force in the hands of Arthur and his Court, but also may be used or misused by his enemies to steal victory from his grasp.
