...
## The App
Each player should download the mobile app and input the group code. Once all players have joined, the app will automatically assign a role to each player and provide character-specific information.
