...
#### Neutral Players
In each game, there is a chance of a Neutral player appearing. Each neutral player has differing goals, but what they all have in common is that they are not innately Good or Evil in the game, and do not necessarily do better or worse when Quests Succeed or Fail:
