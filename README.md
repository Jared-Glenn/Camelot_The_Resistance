...
Some abilities, like Exile, can be handled through the app, allowing a player to select a target and reveal information as needed. In these cases, if the ability involves players leaving the room, they should still remove themselves. It is not necessary for players to show one another their phones, as sharing information will happen automatically through the app. Additional information, when applied mid-game, will be displayed as a norification. Known information can be reviewed at any time.
