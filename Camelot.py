...
def get_role_description(role):
    return {
        ...
        'Iseult' : 'The person you see is also Good and is aware that you are Good.\nYou can be assassinated as either a Lover (which includes either Tristan or Iseult) or as Iseult specifically.\nYou and Tristan each know one location that Excalibur cannot be found.\n.',
        'Lamorak' : 'You can see two pairs of players.\nOne pair of players are on opposite sides (Good and Evil or Pelinor and the Questing Beast), and the other pair are on the same side (Evil and Evil or Good and Good).',
        'Merlin' : 'You know which people have Evil roles, but not who has any specific role.\n',
        'Nimue' : 'You are a member of the Fairy Court and benefit from corrupting the Holy Grail.\n',
